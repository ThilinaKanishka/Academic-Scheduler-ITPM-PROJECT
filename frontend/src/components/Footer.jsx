const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white pt-12 pb-6 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Helping institutions manage courses, faculty, modules, and timetables with our 
              powerful scheduling platform designed for educational excellence.
            </p>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-blue-400 uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-blue-400 uppercase tracking-wider">Contact Us</h3>
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start">
                ...
                <span className="ml-2">support@academicscheduler.lk</span>
              </div>
              <div className="flex items-start">
                <svg className="flex-shrink-0 h-5 w-5 text-blue-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start">
                ...
                <span className="ml-2">Kandy Road, Malabe, Sri Lanka</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-700 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Academic Scheduler. All rights reserved.</p>
